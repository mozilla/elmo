# copy this file to local_setttings.py and enter your local settings in.
# This file is included by settings.py by both django-site and
# l10n-master to connect to the db etc.

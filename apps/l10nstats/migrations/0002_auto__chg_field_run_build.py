...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Run.build'
        db.alter_column('l10nstats_run', 'build_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mbdb.Build'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Run.build'
        db.alter_column('l10nstats_run', 'build_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mbdb.Build'], unique=True, null=True))
    ...
    models = {
        ...
        'l10nstats.run': {
            ...
            'build': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['mbdb.Build']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
